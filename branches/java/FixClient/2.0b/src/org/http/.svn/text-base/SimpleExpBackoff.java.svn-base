...
public class SimpleExpBackoff {    
    ...
    */
    ...
    public static void backoff() {
      ...
      //sleepIncrement *= 2;
      currbackoffCount++;
      sleepIncrement = initialSleep*Functions.randLong(0, (long)(Math.pow(2,currbackoffCount)-1), new Random(System.currentTimeMillis()).nextLong()) ;
