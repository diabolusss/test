...
public class DukasProtocol extends MessageCracker implements Application{
    ...
    public void onMessage(MarketDataSnapshotFullRefresh msg, SessionID sid) throws FieldNotFound{
        ...
        Random r = new Random();
        double rangeMin = (offer > bid)?(bid):(offer);
        double rangeMax = (offer < bid)?(bid):(offer);
    ...
    public static void sendOrderMassStatusRequest(){   
        ...
        try{
            ...
            Functions.printLog("FIXPROTODUKAS:[sendOrderMassStatusRequest] ERR - " + ex.getLocalizedMessage());
            return;
        }
        ...
        try{
            ...
            Functions.printLog("FIXPROTODUKAS:[sendOrderMassStatusRequest] INF - Sending new msg ");
    ...
    public static void sendAccountInfoRequest(){
        ...
        try{
            ...
            Functions.printLog("FIXPROTODUKAS:[sendAccountInfoRequest] ERR - " + ex.getLocalizedMessage());
            return;
        }
        ...
        try{
            Session.sendToTarget(msg, trade_sid);
            Functions.printLog("FIXPROTODUKAS:[sendAccountInfoRequest] INF - Sending new msg ");
