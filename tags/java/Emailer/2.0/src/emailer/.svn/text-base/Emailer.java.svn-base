  ...
  */
  ...
  public void sendEmail(
    ...
    try {
      ...
      Functions.printLog("EMAILER:[SEND] ERR - Cannot send email. " + ex.getLocalizedMessage());
    }
  }
  ...
  */
  private void fetchConfig() {
    ...
    try {
      ...
      Functions.printLog("Emailer:[FETCHCONFIG] ERROR Cannot open and load mail server properties file.");
    }
  }
} 