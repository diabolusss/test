...
public class TestServer extends WebSocketServer{
	...
	public void onMessage(WebSocket connector, String message) {
		// TODO Auto-generated method stub
            ...
            if (message.equals("ping")){
                ...
                connector.send("pong:"+DBMakeQuery.getServerTimeStatus(TicksManager.jdbc_connection, null));
            }
	...
	public void onClose(WebSocket connector, int code, String reason, boolean remote) {
		...
		Functions.printLog(
				...
				reason +
				"; code:"+code+"; remote:"+remote+"]. Total connection number: " + 
				counter
				);
	...
	public void onFragment( WebSocket conn, Framedata fragment ) {
		Functions.printLog( 
				"SERVER:[onFragment] INF - Received fragment[" + 
				fragment + "] from "+
				conn
				);
	}
	...
	public void onError( WebSocket conn, Exception ex ) {
		Functions.printLog(
				"SERVER:[onError] ERR - " + ex.getLocalizedMessage()
