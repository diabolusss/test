...
public class WSocketStatusManager {
    ...
    public static void main(String[] args) {
        ...
        tls_enabled_server = Boolean.parseBoolean(props.getProperty("secured_socket"));
        STORETYPE = props.getProperty("tls_keystore_type");
        KEYSTORE = props.getProperty("tls_key");   
        String host                     = ((tls_enabled_server==true)?("wss://" + props.getProperty("host_to_listen") ):("ws://"+ props.getProperty("host_to_listen")));
        ...
        try {     
            ...
            Functions.printLog("WSocketStatusManager:[INIT] ERR - " + ex.getMessage() + "; Reason: " + ex.getReason() + "; Input: "+ ex.getInput());
        }
