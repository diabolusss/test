...
public class SimpleClient extends WebSocketClient {
	...
	public void onOpen( ServerHandshake handshakedata ) {
            ...
            DBMakeQuery.setSocketAvailable(FixClient.jdbc, null, this.uri.toString().substring(5), 1);
        }
	...
	public void onClose( int code, String reason, boolean remote ) {
            ...
            DBMakeQuery.setSocketAvailable(FixClient.jdbc, null, this.uri.toString().substring(5), 0);
        }
