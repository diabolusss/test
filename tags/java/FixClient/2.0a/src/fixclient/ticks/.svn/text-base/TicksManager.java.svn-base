    ...
    class Scheduler extends TimerTask{
        ...
        public void run() {
            ...
            if((TicksManager.serverStatus == 0) && server_stop.isBefore(now) && server_start.isAfter(now)){                
                ...
                //Functions.printLog("Starting AUTO fix");
                //FixClient.autoFix = new FixAutoRate(FixClient.fixClientProperties, 1.2962, (new DateTime()), (new DateTime().plusDays(2)));
                //FixClient.autoFix.start();
